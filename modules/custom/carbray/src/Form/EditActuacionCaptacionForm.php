...
/**
 * EditActuacionCaptacionForm form.
 */
class EditActuacionCaptacionForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $actuacion_nid = 0) {
    ...
    $form['timer_min'] = array(
      ...
      '#default_value' => $actuacion_node->get('field_actuacion_captacion_tiempo')->value,
    );

    $nota_ref = $actuacion_node->get('field_actuacion_captacion_nota')->getValue();
    if ($nota_ref) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $actuacion->set('field_actuacion_captacion_tiempo', $timer);
